...
def tela_c():
    ...
    pygame.draw.rect(v.tela, (255, 0, 0), rectmaca_a, 2)
    pygame.draw.rect(v.tela, (255, 0, 0), rectgrade, 2)
    pygame.draw.rect(v.tela, (255, 0, 0), rectgrade_a, 2)
    pygame.draw.rect(v.tela, (255, 0, 0), rectkey, 2)
    pygame.draw.rect(v.tela, (255, 0, 0), rectkey_a, 2)
